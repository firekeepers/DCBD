...
from adapteacher.engine.trainer_head_comparation import ATeacherTrainer, BaselineTrainer
...
def main(args):
    ...
    #         args.input = ['/home/shu3090/wcw/datasets/cityscapes_foggy/leftImg8bit_foggy/test/berlin/*']
    #         args.input = glob.glob(os.path.expanduser(args.input[0]))
