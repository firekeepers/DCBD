...
def register_all_VOC_to_clipart(root):
    # root = "manifold://mobile_vision_dataset/tree/yujheli/dataset"
    SPLITS = [
        ("VOC_Clipart1k", "VOC_clipart", "train"),
    ]
    for name, dirname, split in SPLITS:
        year = 2012
        register_pascal_voc(name, os.path.join(root, dirname), split, year)
...
def register_all_VOC_to_watercolor(root):
    # root = "manifold://mobile_vision_dataset/tree/yujheli/dataset"
    SPLITS = [
        ("VOC_watercolor2k", "VOC_watercolor", "train"),
    ]
    for name, dirname, split in SPLITS:
        year = 2012
        register_pascal_voc(name, os.path.join(root, dirname), split, year)
...
register_all_VOC_to_watercolor(_root)
register_all_VOC_to_clipart(_root)

register_coco_instances("sonar_train", {}, _root+"/sonar_train/annotations/instance_train.json", _root+"/sonar_train/train/")
register_coco_instances("sonar_compare", {}, _root+"/sonar_semi/annotations/instance_compare.json", _root+"/sonar_semi/compare/")
register_coco_instances("sonar_semi", {}, _root+"/sonar_semi/annotations/instance_semi.json", _root+"/sonar_semi/semi/")
register_coco_instances("sonar_semi_VALID", {}, _root+"/valid.json", _root+"/valid_img/")
register_coco_instances("sonar_semi_TEST", {}, _root+"/test.json", _root+"/test_img/")

register_coco_instances("cityscapes_foggy_train", {}, _root+"/cityscapes/cocoAnnotations/cityscapes_foggy_train_cocostyle.json", _root+"/cityscapes_foggy/leftImg8bit_foggy/train/")
register_coco_instances("cityscapes", {}, _root+"/cityscapes/cocoAnnotations/cityscapes_train_cocostyle.json", _root+"/cityscapes/leftImg8bit/train/")
register_coco_instances("cityscapes_foggy_val", {}, _root+"/cityscapes/cocoAnnotations/cityscapes_foggy_val_cocostyle.json", _root+"/cityscapes_foggy/leftImg8bit_foggy/val/")
# register_coco_instances("cityscapes_val", {}, _root+"/cityscapes/cocoAnnotations/cityscapes_val_cocostyle.json", _root+"/cityscapes/leftImg8bit/train/")
register_coco_instances("cityscapes_cyclegan", {}, _root+"/cityscapes_cyclegan/cityscapes_fake_train_cocostyle.json", _root+"/cityscapes_cyclegan/leftImg8bit/JPEGImages/")


register_coco_instances("cjk_train", {}, _root+"/changjiangkou/changjiang_source_cocostyle.json", _root+"/changjiangkou/train/")
register_coco_instances("cjk_compare", {}, _root+"/changjiangkou/changjiang_compare_cocostyle.json", _root+"/changjiangkou/compare/")
register_coco_instances("cjk_semi", {}, _root+"/changjiangkou/changjiang_target_cocostyle.json", _root+"/changjiangkou/val/")
# register_coco_instances("sonar_semi_VALID", {}, _root+"/valid.json", _root+"/valid_img/")