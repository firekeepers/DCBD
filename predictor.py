...
def WBF(output_t,output_s,iou_thr = 0.5,skip_box_thr = 0.05,weights = [1,1]):
    ...
    image_size = output_t['instances'].image_size

    boxes_list,scores_list,labels_list = [],[],[]

    box_list_t = output_t['instances'].pred_boxes.tensor
    scores_list_t = output_t['instances'].scores
    classes_list_t = output_t['instances'].pred_classes

    box_list_s = output_s['instances'].pred_boxes.tensor
    scores_list_s = output_s['instances'].scores
    classes_list_s = output_s['instances'].pred_classes
...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            # predictions = self.ensem_ts_model.modelStudent(inputs)

            predictions_T = self.ensem_ts_model.modelTeacher([inputs])
            # predictions_S = self.ensem_ts_model.modelStudent(inputs)[0]
            # predictions = WBF(predictions_T,predictions_S,iou_thr=0.1,skip_box_thr=0.5,weights = [2,1])
